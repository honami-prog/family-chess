...
export const CHESS_TACTICS = [
  ...
  },
  {
    ...
    moves:["d4c4","d6c6"],
    moveComments:{ja:["初期配置：白Kd4 vs 黒Kd6 — 直接オポジション、白番はツークツワング","白Kc4: 動かざるを得ない — オポジション喪失（ツークツワング）","黒Kc6: オポジションを奪い返す — 再び白がツークツワング"],en:["Starting position: White Kd4 vs Black Kd6 — direct opposition, White to move is in zugzwang","White Kc4: forced to move — loses the opposition (zugzwang)","Black Kc6: retakes the opposition — White is in zugzwang again"]},
